...
execute if score $offset count matches 0 positioned ~ ~15 ~-1 run function builder:direction/east
execute unless score $offset count matches 0 positioned ~ ~-1 ~ run function builder:direction/east
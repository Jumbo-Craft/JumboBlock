...
execute if score $offset count matches 0 positioned ~1 ~ ~-15 run function builder:direction/top
execute unless score $offset count matches 0 positioned ~ ~ ~1 run function builder:direction/top
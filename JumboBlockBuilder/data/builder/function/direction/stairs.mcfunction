...
execute if score $west count matches 1 anchored feet positioned ~8 ~15 ~ run function builder:direction/west
...
execute if score $top count matches 1 anchored feet positioned ~ ~7 ~15 run function builder:direction/bottom
execute if score $top count matches 1 anchored feet positioned ~ ~15 ~ run function builder:direction/top
fill ~ ~8 ~ ~7 ~15 ~15 structure_void
